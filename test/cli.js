    ...
    describe('Command Line', function () {
        ...
        it('should be able to set options', function (done) {
            exec('cat ./test/mock/no-lines.info | node ./bin/codacy-coverage.js --debug --verbose --token 1234 --commit 4321 --prefix asdf/ --endpoint something --format lcov', function (err, res) {
                ...
                expect(res).to.match(/Started with: token \["1234"], \[undefined], \[undefined], \[undefined] commitId \["4321"], language \[undefined], endpoint \["something"], format \["lcov"], path prefix \["asdf\/"], verbose \[true], debug \[true]/);
                expect(res).to.match(/Handling input for: token \["1234"], \[undefined], \[undefined], \[undefined] commitId \["4321"], language \[undefined], endpoint \["something"], format \["lcov"], path prefix \["asdf\/"], verbose \[true], debug \[true]/);
                done();
            });
        });
    });
